...
const CanvasPromo = (props) => {
  ...
  return (
    <section className={styles.canvas}>
      <div className={styles["canvas-details"]}>
        <h1>Canvas & Frame</h1>
        <p>
          Our unique canvas and framed prints are the perfect addition to your
          home décor collection.
        </p>
        <Button design="primary" text="Shop Now" icon={rightArrow} />
      </div>
